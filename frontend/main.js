  ...
  const pageContent = {
          ...
          <div class="editor-area">
            <div class="editor-container">
              <div class="toolbar" id="toolbar">
                ...
                <span id="wsIndicator" class="ws-indicator" title="Server connection status" aria-hidden="true"></span>
              </div>
    ...
    characters: `
      <div class="characters-page">
        <!-- Active Characters Column -->
        <aside class="active-characters-column">
          <div class="active-characters-header">
            <div>
              <h3>Active Chat</h3>
              <p>Characters ready to talk</p>
            </div>
          </div>
          <div class="active-characters-list" id="active-character-list"></div>
          <div class="active-characters-empty" id="active-character-empty">
        ...
        <!-- Character Cards Column -->
        <section class="character-card-column">
